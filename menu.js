var data = '[ \
    {"name":"Combo #1", "text":"Item description", "category":"combos", "price":13.99, "popularity":13, "special":false, "image":"placeholder.png"}, \
    ...
    {"name":"Appetizer #2", "text":"Item description", "category":"appetizers", "price":5.49, "popularity":14, "special":false, "image":"placeholder.png"}, \
    {"name":"Appetizer #3", "text":"Item description", "category":"appetizers", "price":4.99, "popularity":1, "special":true, "image":"placeholder.png"}, \
    ...
    {"name":"Side #3", "text":"Item description", "category":"sides", "price":6.49, "popularity":15, "special":false, "image":"placeholder.png"}, \
    {"name":"Main #1", "text":"Item description", "category":"mains", "price":7.99, "popularity":12, "special":true, "image":"placeholder.png"}, \
    ...
    {"name":"Dessert #2", "text":"Item description", "category":"desserts", "price":5.49, "popularity":11, "special":false, "image":"placeholder.png"}, \
    {"name":"Dessert #3", "text":"Item description", "category":"desserts", "price":2.99, "popularity":4, "special":true, "image":"placeholder.png"} \
]';
...
function refreshOrderList() {
    ...
    for (i=0; i<orders.length; i++) {
        ...
        for (j=0; j<orders[i].items.length; j++) {
            ...
            text2.setAttribute("id", "orderListItemTextPrice");
