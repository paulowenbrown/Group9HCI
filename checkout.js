...
function showCheckoutInfo() {
  ...
  for (i = 0; i < orders.length; i++) {
    ...
    sectionName.setAttribute("class", "orderSectionNameCheckout");
    ...
    var itemListText = document.createElement("h3");
    itemListText.appendChild(document.createTextNode("Item List:"));
    section.appendChild(itemListText);
